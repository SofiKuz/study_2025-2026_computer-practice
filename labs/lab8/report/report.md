...
Выполним примеры из лабораторной работы.
...
![1 Задание - Линейное программирование](image/12.png){#fig:012 width=70%}

![2 Задание - Линейное программирование. Использование массивов](image/13.png){#fig:013 width=70%}

![3 Задание - Выпуклое программирование](image/14.png){#fig:014 width=70%}

![4 Задание - Оптимальная рассадка по залам](image/15.png){#fig:015 width=70%}

![5 Задание - План приготовления кофе](image/16.png){#fig:016 width=70%}
